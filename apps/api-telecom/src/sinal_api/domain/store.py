...
PLANS: dict[str, Plan] = {
    ...
    for p in [
        ...
        Plan(
            ...
            unlimited_apps=["mensagens", "musica"],
        ...
        Plan(
            ...
            unlimited_apps=["mensagens", "musica", "video"],
            minutes="ilimitado nacional",
        ),
    ]
}
...
CUSTOMERS: dict[str, Customer] = {
    ...
    for c in [
        ...
        Customer(
            ...
            segment="varejo",
            since=date(2022, 8, 2),
            email="rafael.queiroz@exemplo.test",
        ),
        Customer(
            id="CUS-2001",
...
TICKETS: dict[str, Ticket] = {
    ...
    for t in [
        Ticket(
            ...
            summary="Instabilidade de sinal na regiao central",
        ...
        Ticket(
            ...
            summary="Divergencia de valor na fatura de agosto",
